...
import center from '@/views/center'
    import qianxianfuwu from '@/views/modules/qianxianfuwu/list'
    ...
    import canjiaxinxi from '@/views/modules/canjiaxinxi/list'
    import chat from '@/views/modules/chat/list'
    import huiyuancanjia from '@/views/modules/huiyuancanjia/list'
    ...
    import huiyuanzhanghu from '@/views/modules/huiyuanzhanghu/list'

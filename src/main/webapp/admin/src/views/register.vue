  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">婚恋网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="出生日期" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.chushengriqi" autocomplete="off" placeholder="出生日期"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='huiyuan'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`huiyuan` == this.tableName && this.ruleForm.lianxishouji&&(!this.$validate.isMobile(this.ruleForm.lianxishouji))){

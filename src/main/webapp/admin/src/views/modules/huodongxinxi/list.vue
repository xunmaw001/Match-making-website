<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('huodongxinxi','用户参加') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="canjiaxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'用户参加':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','用户参加') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="canjiaxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'用户参加':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huodongxinxi','用户参加') && contents.tableBtnIcon == 0" type="success" size="mini" @click="canjiaxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'用户参加':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','会员参加') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huiyuancanjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'会员参加':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','会员参加') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huiyuancanjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'会员参加':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huodongxinxi','会员参加') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huiyuancanjiaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'会员参加':'' }}</el-button>
    ...
    <canjiaxinxi-cross-add-or-update v-if="canjiaxinxiCrossAddOrUpdateFlag" :parent="this" ref="canjiaxinxiCrossaddOrUpdate"></canjiaxinxi-cross-add-or-update>
    <huiyuancanjia-cross-add-or-update v-if="huiyuancanjiaCrossAddOrUpdateFlag" :parent="this" ref="huiyuancanjiaCrossaddOrUpdate"></huiyuancanjia-cross-add-or-update>
...
import canjiaxinxiCrossAddOrUpdate from "../canjiaxinxi/add-or-update";
import huiyuancanjiaCrossAddOrUpdate from "../huiyuancanjia/add-or-update";
export default {
  data() {
    return {
      ...
      canjiaxinxiCrossAddOrUpdateFlag: false,
      huiyuancanjiaCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    canjiaxinxiCrossAddOrUpdate,
    huiyuancanjiaCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    canjiaxinxiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.canjiaxinxiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','huodongxinxi');
      this.$nextTick(() => {
      this.$refs.canjiaxinxiCrossaddOrUpdate.init(row.id,type);
      });
    },
    huiyuancanjiaCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.huiyuancanjiaCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','huodongxinxi');
      this.$nextTick(() => {
      this.$refs.huiyuancanjiaCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
          this.$http({

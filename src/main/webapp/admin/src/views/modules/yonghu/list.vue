<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yonghu','签线') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="qianxianfuwuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'签线':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','签线') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="qianxianfuwuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'签线':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yonghu','签线') && contents.tableBtnIcon == 0" type="success" size="mini" @click="qianxianfuwuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'签线':'' }}</el-button>
    ...
    <qianxianfuwu-cross-add-or-update v-if="qianxianfuwuCrossAddOrUpdateFlag" :parent="this" ref="qianxianfuwuCrossaddOrUpdate"></qianxianfuwu-cross-add-or-update>
...
import qianxianfuwuCrossAddOrUpdate from "../qianxianfuwu/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      qianxianfuwuCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    qianxianfuwuCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.qianxianfuwuCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yonghu');
      this.$nextTick(() => {
      this.$refs.qianxianfuwuCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
    },

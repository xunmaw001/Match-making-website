<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消费名称" prop="xiaofeimingcheng">
          <el-input v-model="ruleForm.xiaofeimingcheng" 
              placeholder="消费名称" clearable  :readonly="ro.xiaofeimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消费名称" prop="xiaofeimingcheng">
              <el-input v-model="ruleForm.xiaofeimingcheng" 
                placeholder="消费名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	xiaofeiriqi : false,
      ...
      rules: {
          xiaofeibianhao: [
                { required: true, message: '消费编号不能为空', trigger: 'blur' },
          ],
          huiyuanzhanghao: [
          ],
          huiyuanxingming: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='xiaofeimingcheng'){
            this.ruleForm.xiaofeimingcheng = obj[o];
	    this.ro.xiaofeimingcheng = true;
            continue;
          }
          if(o=='xiaofeiriqi'){
